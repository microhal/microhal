...
// we're being parsed by a JetBrains IDE for
// analytics) because, at time of writing, __COUNTER__ is not properly handled
// by it.
...
#define INTERNAL_CATCH_TEST_NO_TRY(macroName, resultDisposition, expr)     \
  do {                                                                     \
    ...
    INTERNAL_CATCH_REACT(__catchResult)                                    \
      ...
      false &&                                                             \
      static_cast<bool>(!!(expr))))  // expr here is never evaluated at
