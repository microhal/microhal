...
#ifndef SRC_MICROHAL_PORTS_STMCOMMON_CLOCKMANAGER_HASHCLOCK_H_
#define SRC_MICROHAL_PORTS_STMCOMMON_CLOCKMANAGER_HASHCLOCK_H_
...
#if defined(_MICROHAL_HASH_BASE_ADDRESS)
#if defined(_MICROHAL_CLOCKMANAGER_HAS_POWERMODE) && _MICROHAL_CLOCKMANAGER_HAS_POWERMODE == 1

static void enableHASH(PowerMode mode) {
...
static void disableHASH(PowerMode mode) {
    auto ahb2enr = registers::rcc->ahb2enr.volatileLoad();
    auto ahb2lpenr = registers::rcc->ahb2lpenr.volatileLoad();
...
#endif /* SRC_MICROHAL_PORTS_STMCOMMON_CLOCKMANAGER_HASHCLOCK_H_ */
