...
#ifndef _MICROHAL_PORTS_IOMANAGER_STM32G071_H_
#define _MICROHAL_PORTS_IOMANAGER_STM32G071_H_
...
class IOManager {
    ...
    constexpr static GPIO::AlternateFunction get_alternate_function(Peripheral peripheral, PinFunction pin_function, IOPin pin) {
        ...
        const std::array<const PinOption, 234> pin_options = {
            ...
            PinOption{IOPin{IOPin::PortA, 0}, Peripheral::LPTIM1, PinFunction::Timer_OUT, AF::AF5},
            ...
            PinOption{IOPin{IOPin::PortA, 4}, Peripheral::LPTIM2, PinFunction::Timer_OUT, AF::AF5},
            ...
            PinOption{IOPin{IOPin::PortA, 5}, Peripheral::LPTIM2, PinFunction::Timer_ETRU, AF::AF5},
            ...
            PinOption{IOPin{IOPin::PortA, 8}, Peripheral::LPTIM2, PinFunction::Timer_OUT, AF::AF5},
            ...
            PinOption{IOPin{IOPin::PortB, 0}, Peripheral::LPTIM1, PinFunction::Timer_OUT, AF::AF5},
            ...
            PinOption{IOPin{IOPin::PortB, 1}, Peripheral::LPTIM2, PinFunction::Timer_IN1, AF::AF5},
            ...
            PinOption{IOPin{IOPin::PortB, 2}, Peripheral::LPTIM1, PinFunction::Timer_OUT, AF::AF5},
            ...
            PinOption{IOPin{IOPin::PortB, 5}, Peripheral::LPTIM1, PinFunction::Timer_IN1, AF::AF5},
            ...
            PinOption{IOPin{IOPin::PortB, 6}, Peripheral::LPTIM1, PinFunction::Timer_ETR, AF::AF5},
            ...
            PinOption{IOPin{IOPin::PortB, 7}, Peripheral::LPTIM1, PinFunction::Timer_IN2, AF::AF5},
            ...
            PinOption{IOPin{IOPin::PortC, 0}, Peripheral::LPTIM1, PinFunction::Timer_IN1, AF::AF0},
            PinOption{IOPin{IOPin::PortC, 0}, Peripheral::LPTIM2, PinFunction::Timer_IN1, AF::AF2},
            PinOption{IOPin{IOPin::PortC, 1}, Peripheral::LPTIM1, PinFunction::Timer_OUT, AF::AF0},
            PinOption{IOPin{IOPin::PortC, 1}, Peripheral::TIM15, PinFunction::Timer_CH1, AF::AF2},
            PinOption{IOPin{IOPin::PortC, 2}, Peripheral::LPTIM1, PinFunction::Timer_IN2, AF::AF0},
            ...
            PinOption{IOPin{IOPin::PortC, 3}, Peripheral::LPTIM1, PinFunction::Timer_ETR, AF::AF0},
            PinOption{IOPin{IOPin::PortC, 3}, Peripheral::SPI2, PinFunction::SPI_MOSI, AF::AF1},
            PinOption{IOPin{IOPin::PortC, 3}, Peripheral::LPTIM2, PinFunction::Timer_ETR, AF::AF2},
            ...
            PinOption{IOPin{IOPin::PortC, 4}, Peripheral::TIM2, PinFunction::Timer_CH1_ETR, AF::AF2},
            ...
            PinOption{IOPin{IOPin::PortC, 5}, Peripheral::TIM2, PinFunction::Timer_CH2, AF::AF2},
            ...
            PinOption{IOPin{IOPin::PortC, 6}, Peripheral::TIM2, PinFunction::Timer_CH3, AF::AF2},
            PinOption{IOPin{IOPin::PortC, 7}, Peripheral::TIM3, PinFunction::Timer_CH2, AF::AF1},
            PinOption{IOPin{IOPin::PortC, 7}, Peripheral::TIM2, PinFunction::Timer_CH4, AF::AF2},
            ...
            PinOption{IOPin{IOPin::PortC, 12}, Peripheral::LPTIM1, PinFunction::Timer_IN1, AF::AF0},
            ...
            PinOption{IOPin{IOPin::PortD, 6}, Peripheral::TIM2, PinFunction::Timer_OUT, AF::AF2},
            ...
            PinOption{IOPin{IOPin::PortD, 8}, Peripheral::TIM1, PinFunction::Timer_OUT, AF::AF2},
    ...
    static void route_SerialPort(stm32g0xx::GPIO::PullType rxd_pull = GPIO::PullType::NoPull,
        ...
        if constexpr (rxd_pin != IOPinOrUnused::Unused) {
            ...
            static_assert(alternate_function != AlternateFunction::Invalid || peripheral != Peripheral::SerialPort1,
                          "LPUART1_RX can be connected to: PortA.3, PortB.10 or PortC.0");
        ...
        if constexpr (txd_pin != IOPinOrUnused::Unused) {
            ...
            static_assert(alternate_function != AlternateFunction::Invalid || peripheral != Peripheral::SerialPort1,
                          "LPUART1_TX can be connected to: PortA.2, PortB.11 or PortC.1");
            static_assert(alternate_function != AlternateFunction::Invalid || peripheral != Peripheral::SerialPort3,
...
#endif  // _MICROHAL_PORTS_IOMANAGER_STM32G071_H_
