...
// Supported MCU: STM32F107

#define _MICROHAL_REGISTERS_RCC_CFGR_HAS_PPRE2
#define _MICROHAL_REGISTERS_RCC_BDCR_RTCSEL_HAS_HSE_DIV_128
#define _MICROHAL_REGISTERS_RCC_AHBENR_HAS_OTGFSEN
#define _MICROHAL_REGISTERS_RCC_HAS_CFGR2
#define _MICROHAL_REGISTERS_RCC_CRGR2_HAS_PREDIV1SRC
...
struct RCC {
    ...
    union CR {
        union {
            ...
            microhal::Bitfield<uint32_t, 26, 1> PLL2ON;  /*!< PLL2 enable */
            microhal::Bitfield<uint32_t, 27, 1> PLL2RDY; /*!< PLL2 clock ready flag */
            microhal::Bitfield<uint32_t, 28, 1> PLL3ON;  /*!< PLL3 enable */
            microhal::Bitfield<uint32_t, 29, 1> PLL3RDY; /*!< PLL3 clock ready flag */
        };
    ...
    union CIR {
        union {
            ...
            microhal::Bitfield<uint32_t, 5, 1> PLL2RDYF;   /*!< PLL2 Ready Interrupt flag */
            microhal::Bitfield<uint32_t, 6, 1> PLL3RDYF;   /*!< PLL3 Ready Interrupt flag */
            ...
            microhal::Bitfield<uint32_t, 13, 1> PLL2RDYIE; /*!< PLL2 Ready Interrupt Enable */
            microhal::Bitfield<uint32_t, 14, 1> PLL3RDYIE; /*!< PLL3 Ready Interrupt Enable */
            ...
            microhal::Bitfield<uint32_t, 21, 1> PLL2RDYC;  /*!< PLL2 Ready Interrupt Clear */
            microhal::Bitfield<uint32_t, 22, 1> PLL3RDYC;  /*!< PLL3 Ready Interrupt Clear */
    ...
    union APB1RSTR {
        union {
            ...
            microhal::Bitfield<uint32_t, 19, 1> USART4RST; /*!< USART 4 reset */
            microhal::Bitfield<uint32_t, 20, 1> USART5RST; /*!< USART 5 reset */
    ...
    union AHBENR {
        union {
            ...
            microhal::Bitfield<uint32_t, 12, 1> OTGFSEN;    /*!< USB OTG FS clock enable */
            microhal::Bitfield<uint32_t, 14, 1> ETHMACEN;   /*!< Ethernet MAC clock enable */
            microhal::Bitfield<uint32_t, 15, 1> ETHMACTXEN; /*!< Ethernet MAC TX clock enable */
            microhal::Bitfield<uint32_t, 16, 1> ETHMACRXEN; /*!< Ethernet MAC RX clock enable */
        };
    ...
    union APB1ENR {
        union {
            ...
            microhal::Bitfield<uint32_t, 25, 1> CAN1EN;   /*!< CAN1 clock enable */
            microhal::Bitfield<uint32_t, 26, 1> CAN2EN;   /*!< CAN2 clock enable */
    ...
    union AHBRSTR {
        union {
            microhal::Bitfield<uint32_t, 12, 1> OTGFSRST;  /*!< USB OTG FS reset */
            microhal::Bitfield<uint32_t, 14, 1> ETHMACRST; /*!< Ethernet MAC reset */
        };
    ...
    union CFGR2 {
        union {
            microhal::Bitfield<uint32_t, 0, 4> PREDIV1;     /*!< PREDIV1 division factor */
            microhal::Bitfield<uint32_t, 4, 4> PREDIV2;     /*!< PREDIV2 division factor */
            microhal::Bitfield<uint32_t, 8, 4> PLL2MUL;     /*!< PLL2 Multiplication Factor */
            microhal::Bitfield<uint32_t, 12, 4> PLL3MUL;    /*!< PLL3 Multiplication Factor */
            microhal::Bitfield<uint32_t, 16, 1> PREDIV1SRC; /*!< PREDIV1 entry clock source */
            microhal::Bitfield<uint32_t, 17, 1> I2S2SRC;    /*!< I2S2 clock source */
            microhal::Bitfield<uint32_t, 18, 1> I2S3SRC;    /*!< I2S3 clock source */
        };
    ...
    VolatileRegister<AHBRSTR, AccessType::ReadWrite> ahbrstr;   /*!< AHB peripheral clock reset register (RCC_AHBRSTR)	Address offset: 0x28 */
    VolatileRegister<CFGR2, AccessType::ReadWrite> cfgr2;       /*!< Clock configuration register2 (RCC_CFGR2)	Address offset: 0x2C */
};
